...
# ── Language helpers ───────────────────────────────────────────────────────────
#
# The language dataset and script-based detection live in namer.language;
# they are re-exported here so existing notebooks/scripts that call
# ``wikipedia.is_valid_language`` keep working unchanged.

from namer.language import (  # noqa: F401
    is_valid_language,
